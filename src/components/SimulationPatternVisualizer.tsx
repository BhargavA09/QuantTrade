...
interface SimulationPatternVisualizerProps {
  patterns: Pattern[];
  summary: string;
}

const SimulationPatternVisualizer: React.FC<SimulationPatternVisualizerProps> = ({ patterns, summary }) => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-black uppercase tracking-widest text-zinc-100">Simulation Pattern Intelligence</h3>
        </div>
...
export default SimulationPatternVisualizer;
